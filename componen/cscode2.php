...
<body>
  <div style="height: 100%; display: flex; justify-content: center;">
    <div style="display: flex; border-bottom: solid 1px lightgray; position: fixed; padding: 20px 0; width: 100%; justify-content: center; background-color: white; top: 0;">
      <a href="./cscode.php"><i class="fi fi-rr-arrow-small-left" style="position: fixed; left: 5%;font-size: 1.5em; color: black;"></i></a>
      <p>Change Security Code</p>
  </div>
    <form action="../main/bar.php?profile" method="post" style="width: 84%; height: 100%">
    <div style="height: 100%; width: 100%; display: flex; align-items: center; flex-direction: column; justify-content: center">
        <div style="background-color: black;"></div>
        <label style="width: 80%; text-align: center; margin-top: 0; font-size: 0.8em;">Buat Security Code Baru.</label>
